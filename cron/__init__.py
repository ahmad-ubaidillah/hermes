"""
Cron job scheduling system for Aizen Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    aizen gateway install    # Install as a user service
    sudo aizen gateway install --system  # Linux servers: boot-time system service
    aizen gateway            # Or run in foreground
