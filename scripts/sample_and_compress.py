...
DEFAULT_DATASETS = [
    ...
    "NousResearch/aizen-agent-megascience-sft1",
    "NousResearch/Aizen-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Aizen-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-aizen-agent"
]
