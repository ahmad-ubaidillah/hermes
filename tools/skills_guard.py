...
Trust levels:
  - builtin:   Ships with Aizen. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.aizen/\.env|\~/\.aizen/\.env',
     "aizen_env_access", "critical", "exfiltration",
     "directly references Aizen secrets file"),
    ...
    (r'\.aizen/config\.yaml|\.aizen/SOUL\.md',
     "aizen_config_mod", "critical", "persistence",
     "references Aizen configuration files directly"),
...
def _get_configured_model() -> str:
    """Load the user's configured model from ~/.aizen/config.yaml."""
    try:
