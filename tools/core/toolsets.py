...
Usage:
    from tools.toolsets import get_toolset, resolve_toolset, get_all_toolsets
...
_AIZEN_CORE_TOOLS = [
    ...
    "opencode_coding_task",
    "opencode_edit_file",
    "opencode_review_code",
    "opencode_explain_code",
    "opencode_generate_code",
    "opencode_status",
    # Key rotation (gated on multiple keys via check_fn)
    "key_rotation",
    # Credential storage
    "credential_storage",
]
...
TOOLSETS = {
    ...
    "opencode": {
        "description": "OpenCode collaboration tools - delegate coding tasks, edit files, review code, generate code",
        "tools": [
            "opencode_coding_task",
            "opencode_edit_file",
            "opencode_review_code",
