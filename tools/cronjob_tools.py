"""
Cron job management tools for Aizen Agent.
...
def _origin_from_env() -> Optional[Dict[str, str]]:
    origin_platform = os.getenv("AIZEN_SESSION_PLATFORM")
    origin_chat_id = os.getenv("AIZEN_SESSION_CHAT_ID")
    if origin_platform and origin_chat_id:
        return {
            "platform": origin_platform,
            "chat_id": origin_chat_id,
            "chat_name": os.getenv("AIZEN_SESSION_CHAT_NAME"),
            "thread_id": os.getenv("AIZEN_SESSION_THREAD_ID"),
        }
    return None
...
def check_cronjob_requirements() -> bool:
    ...
    """
    return bool(
        os.getenv("AIZEN_INTERACTIVE")
        or os.getenv("AIZEN_GATEWAY_SESSION")
        or os.getenv("AIZEN_EXEC_ASK")
    )
