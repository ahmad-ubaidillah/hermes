...
- GET  /v1/models                  — lists aizen-agent as an available model
- GET  /health                     — health check

Any OpenAI-compatible frontend (Open WebUI, LobeChat, LibreChat,
AnythingLLM, NextChat, ChatBox, etc.) can connect to aizen-agent
    ...
    def __init__(self, max_size: int = MAX_STORED_RESPONSES, db_path: str = None):
        ...
        if db_path is None:
            try:
                ...
                db_path = str(get_aizen_home() / "response_store.db")
            except Exception:
                db_path = ":memory:"
        try:
...
class APIServerAdapter(BasePlatformAdapter):
    ...
    and routes them through aizen-agent's AIAgent.
    """
    ...
    def _create_agent(
        ...
        gateway platforms), falling back to the aizen-api-server default.
        """
    ...
    async def _handle_health(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({"status": "ok", "platform": "aizen-agent"})

    async def _handle_models(self, request: "web.Request") -> "web.Response":
        """GET /v1/models — return aizen-agent as an available model."""
    ...
    async def _handle_chat_completions(self, request: "web.Request") -> "web.Response":
        ...
        model_name = body.get("model", "aizen-agent")
        created = int(time.time())
    ...
    async def _handle_responses(self, request: "web.Request") -> "web.Response":
        ...
        response_data = {
            ...
            "model": body.get("model", "aizen-agent"),
            "output": output_items,
            "usage": {
