"""
Email platform adapter for the Aizen gateway.

Allows users to interact with Aizen by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Aizen Agent")
        ...
        msg_id = f"<aizen-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
