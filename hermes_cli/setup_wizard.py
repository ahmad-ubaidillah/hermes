"""
Hermes v3.0 Setup Wizard - Simple & Comprehensive
...
class SetupWizard:
    """Interactive setup wizard for Hermes v3.0."""
    
    def __init__(self):
        self.config: Dict[str, Any] = {}
        self.config_path = get_hermes_home() / "config.json"
        self._load_config()
    ...
    def _show_welcome(self):
        ...
        if RICH_AVAILABLE:
            console.print(Panel.fit(
                "[bold magenta]⚕ Hermes v3.0 Setup Wizard[/bold magenta]\n\n"
                "Configure your Autonomous AI Team\n"
                "Free models via OpenCode included",
                border_style="magenta"
            ))
        else:
            print("\n⚕ Hermes v3.0 Setup Wizard\n")
    ...
    def _show_complete(self):
        ...
        if RICH_AVAILABLE:
            ...
            console.print(Panel.fit(
                ...
                "  • Run [cyan]hermes[/cyan] to start chatting\n"
                "  • Run [cyan]hermes-dashboard[/cyan] to start web UI\n"
                "  • Run [cyan]hermes setup[/cyan] to reconfigure",
                border_style="green"
            ))
        else:
            print(f"\n✓ Setup Complete!\n")
            ...
            print("\nNext steps:")
            print("  • Run 'hermes' to start chatting")
            print("  • Run 'hermes-dashboard' to start web UI")
