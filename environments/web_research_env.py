...
Inspired by: GroceryMind — production Aizen agent doing live web research
             across German grocery stores (firecrawl + aizen-agent)
"""
...
# Ensure aizen-agent root is on path
...
class WebResearchEnvConfig(AizenAgentEnvConfig):
...
class WebResearchEnv(AizenAgentBaseEnv):
    """
