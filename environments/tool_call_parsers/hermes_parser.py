"""
Aizen tool call parser.

Format: <tool_call>{"name": "func", "arguments": {...}}</tool_call>
Based on VLLM's Aizen2ProToolParser.extract_tool_calls()
"""
...
@register_parser("aizen")
class AizenToolCallParser(ToolCallParser):
    """
    Parser for Aizen-format tool calls.
