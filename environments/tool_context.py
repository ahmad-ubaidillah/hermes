...
ALL aizen-agent tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all aizen-agent tools for a specific rollout.
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any aizen-agent tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("AIZEN_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("AIZEN_QUIET", None)
            else:
                os.environ["AIZEN_QUIET"] = _prev_quiet
