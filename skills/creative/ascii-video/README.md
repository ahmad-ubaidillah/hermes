...
Built for [Aizen Agent](https://github.com/NousResearch/aizen-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/aizen-agent/skills/creative/ascii-video`](https://github.com/NousResearch/aizen-agent/tree/main/skills/creative/ascii-video) via PR.
