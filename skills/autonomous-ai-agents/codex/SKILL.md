...
metadata:
  aizen:
    ...
    related_skills: [claude-code, aizen-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Aizen terminal. Codex is OpenAI's autonomous coding agent CLI.
