...
metadata:
  aizen:
    ...
    related_skills: [codex, aizen-agent]
---

# Claude Code

Delegate coding tasks to [Claude Code](https://docs.anthropic.com/en/docs/claude-code) via the Aizen terminal. Claude Code is Anthropic's autonomous coding agent CLI.
