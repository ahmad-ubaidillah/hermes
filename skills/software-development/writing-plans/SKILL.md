...
version: 1.1.0
author: Aizen Agent (adapted from obra/superpowers)
license: MIT
metadata:
  aizen:
...
> **For Aizen:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Aizen tools to understand the project:
