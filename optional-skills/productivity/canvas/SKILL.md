...
4. Name the token (e.g., "Aizen Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.aizen/.env`:
...
```bash
CANVAS="python $AIZEN_HOME/skills/productivity/canvas/scripts/canvas_api.py"
