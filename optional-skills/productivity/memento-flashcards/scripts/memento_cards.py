...
Data file: $AIZEN_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_AIZEN_HOME = Path(os.environ.get("AIZEN_HOME", Path.home() / ".aizen"))
DATA_DIR = _AIZEN_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
