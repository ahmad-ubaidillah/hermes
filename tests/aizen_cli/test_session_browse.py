"""Tests for the interactive session browser (`aizen sessions browse`).
...
from aizen_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """aizen sessions browse should be parseable."""
        from aizen_cli.main import main as _main_entry
