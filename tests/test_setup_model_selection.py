...
class TestSetupProviderModelSelection:
    ...
    @patch("aizen_cli.models.fetch_api_models", return_value=[])
    @patch("aizen_cli.config.get_env_value", return_value="fake-key")
    def test_falls_back_to_default_models_without_crashing(
        ...
        from aizen_cli.setup import _setup_provider_model_selection
        ...
        with patch("aizen_cli.auth.PROVIDER_REGISTRY", mock_provider_registry):
    ...
    @patch("aizen_cli.models.fetch_api_models")
    @patch("aizen_cli.config.get_env_value", return_value="fake-key")
    ...
    def test_custom_model_selection(
        ...
        from aizen_cli.setup import _setup_provider_model_selection, _DEFAULT_PROVIDER_MODELS
