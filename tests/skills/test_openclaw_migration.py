...
"""
    ...
    assert "Tyler Williams > Active Projects: Aizen Agent" in entries
...
def test_skill_installs_cleanly_under_skills_guard():
    ...
    # aizen_config_mod  — print statements in the post-migration summary that
    #                      tell the user to *review* ~/.aizen/config.yaml;
    ...
    KNOWN_FALSE_POSITIVES = {"agent_config_mod", "python_os_environ", "aizen_config_mod"}
