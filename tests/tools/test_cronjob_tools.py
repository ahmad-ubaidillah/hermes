...
class TestCronjobRequirements:
    def test_requires_no_crontab_binary(self, monkeypatch):
        ...
        # because aizen uses an internal scheduler, not system crontab.
    ...
    def test_accepts_gateway_session(self, monkeypatch):
        monkeypatch.delenv("AIZEN_INTERACTIVE", raising=False)
        monkeypatch.setenv("AIZEN_GATEWAY_SESSION", "1")
        monkeypatch.delenv("AIZEN_EXEC_ASK", raising=False)
    ...
    def test_accepts_exec_ask(self, monkeypatch):
        monkeypatch.delenv("AIZEN_INTERACTIVE", raising=False)
        monkeypatch.delenv("AIZEN_GATEWAY_SESSION", raising=False)
        monkeypatch.setenv("AIZEN_EXEC_ASK", "1")
...
class TestScheduleCronjob:
    ...
    def test_thread_id_captured_in_origin(self, monkeypatch):
        ...
        monkeypatch.setenv("AIZEN_SESSION_CHAT_ID", "123456")
        monkeypatch.setenv("AIZEN_SESSION_THREAD_ID", "42")
