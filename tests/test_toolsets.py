...
class TestToolsetConsistency:
    ...
    def test_aizen_platforms_share_core_tools(self):
        """All aizen-* platform toolsets should have the same tools."""
        platforms = ["aizen-cli", "aizen-telegram", "aizen-discord", "aizen-whatsapp", "aizen-slack", "aizen-signal", "aizen-homeassistant"]
