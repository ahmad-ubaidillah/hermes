"""Tests for aizen_logging module."""
...
class TestRedactSecrets:
    ...
    def test_redaction_can_be_disabled(self):
        import aizen_logging

        # Patch the module-level variable directly instead of reloading
        with patch.object(aizen_logging, "_REDACT_ENABLED", False):
            result = aizen_logging.redact_secrets("sk-abc...o345")
...
class TestConversationTracer:
    ...
    def test_tracer_enabled_via_env(self, monkeypatch, tmp_path):
        monkeypatch.setenv("AIZEN_ENABLE_TRACING", "true")
