...
class TestParserRegistry:
    ...
    def test_aizen_parser_registered(self):
        parsers = list_parsers()
        assert "aizen" in parsers
...
class TestAizenParser:
    @pytest.fixture
    def parser(self):
        return get_parser("aizen")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["aizen"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use aizen format since that's universal
