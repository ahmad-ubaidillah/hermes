"""Hermes Structured Logging Module
...
# ---------------------------------------------------------------------------
# Hermes home (needed by ConversationTracer default)
# ---------------------------------------------------------------------------
...
def configure_logging(
    ...
    if quiet:
        for name in ("tools", "run_agent", "gateway", "agent", "hermes_cli"):
