"""Aizen CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.aizen/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Aizen Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Aizen "       # Response box header label
...
.. code-block:: python
    ...
    from aizen_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Aizen Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.aizen/skins/
...
Drop a YAML file in ``~/.aizen/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces AIZEN_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces AIZEN_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "OpenCode-style dark theme with cyan accents",
        "colors": {
            ...
            "session_label": "#58A6FF",
            "session_border": "#30363D",
        },
        "spinner": {
            # RPG-style spinner messages
            "waiting_faces": ["(⚔)", "(⛨)", "(▲)", "(z)", "(◆)"],
            "thinking_faces": ["(⚔)", "(⛨)", "(▲)", "(⌁)", "(<>)"],
            "thinking_verbs": [
                "assigning", "reviewing", "repeating", "executing",
                "planning", "synthesizing", "forging", "channeling",
            ],
            "wings": [
                ["⟪z", "z⟫"],
                ["⟪▲", "▲⟫"],
        ...
        "branding": {
            "agent_name": "Aizen Agent",
            "welcome": "Welcome to Aizen Agent! Execute with Zen. Type /help for commands.",
            "goodbye": "Goodbye! Execute with Zen <z>",
            "response_label": " <z> Aizen ",
            "prompt_symbol": "❯ ",
            "help_header": "(<z>)? Available Commands",
        },
        "tool_prefix": "┊",
    },
    "ares": {
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "branding": {
            "agent_name": "Aizen Agent",
            "welcome": "Welcome to Aizen Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Aizen ",
            "prompt_symbol": "❯ ",
            "help_header": "[?] Available Commands",
        },
        "tool_prefix": "┊",
