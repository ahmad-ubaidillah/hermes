...
Usage:
    aizen pairing list              # Show all pending + approved users
    aizen pairing approve <platform> <code>  # Approve a pairing code
    aizen pairing revoke <platform> <user_id> # Revoke user access
    aizen pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle aizen pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: aizen pairing {list|approve|revoke|clear-pending}")
        print("Run 'aizen pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'aizen pairing list' to see pending codes.\n")
